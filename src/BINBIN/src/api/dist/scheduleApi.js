...
var sanitize_1 = require("../security/sanitize");
...
apiClient.interceptors.request.use(function (config) {
    if (config.data) {
        config.data = sanitize_1.sanitizeInput(config.data);
    }
    if (config.params) {
        config.params = sanitize_1.sanitizeInput(config.params);
    }
...
exports.fetchSchedule = function (weekNumber, year) { return __awaiter(void 0, void 0, void 0, function () {
    var response, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, apiClient.get("/schedule", {
                        params: {
                            week: weekNumber,
                            year: year
                        },
